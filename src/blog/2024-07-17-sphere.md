...
**Current status:** post MVP / TRL6 - Full-scale protoype field demonstration

**Update:** TRL7 - Full-scale prototype in commercial context 

**About:**

The Sphere is a sound-proof spherical pod for one person to sit inside, with integrated omnidirectional microphone and loudspeaker system, vibro-acoustic chair and on-board spatial audio and data processing functions. 

A personalized sound treatment is provided by projecting sound waves and vibrations onto the user’s body and real-time capturing the user’s individual acoustic profile to optimize auditory entrainment. In this way, the Sphere guides the user towards improved homeostasis, which promotes greater physical and emotional health and resilience. A treatment session in the Sphere takes between 25–50 minutes, depending on the intended effect \[1]. 

Effects of sound interventions with the Sphere have been observed relating to effective stress alleviation, regulation of arousal for mood and sleep modulation \[2], promotion of cardiovascular functions and blood cell longevity \[2,3], increased focus, attention, innovative thinking, heightened creativity and improved memory functions, and other reported benefits \[2]. The effects during and after a treatment may vary among users depending on their personal condition and needs.

Assessment and monitoring are provided by personal reports accessible through an online app. The reports translate acoustic information captured in the Sphere to factors relating to the user’s physical, emotional and mental wellbeing.
...
\[3] [R. Geffen et al., “Effects of Sound Immersion on In Vitro Blood Cells”, 09-Oct-2023. \[Online]. Available: osf.io/b4gs6](https://osf.io/preprints/osf/b4gs6_v1)

**Patents:** 

[P. Oomen, Entrainment System and Method, WO2025/005790 A1, 2025.](https://www.theworks.info/blog/2025-02-05-entrainment-method-and-system/)[](https://www.theworks.info/blog/2023-01-19-environmental-sound-loudspeaker/)
